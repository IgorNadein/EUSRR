...
3. [Архитектура и Модели](#архитектура-и-модели)
4. [Права Доступа](#права-доступа)
5. [Workflow Согласования](#workflow-согласования)
6. [API Endpoints](#api-endpoints)
7. [UI/UX Компоненты](#uiux-компоненты)
8. [Этапы Реализации](#этапы-реализации)
9. [Технологический Стек](#технологический-стек)
10. [Чеклист Реализации](#чеклист-реализации)

---

## Архитектурные Решения

### 🔔 Система Уведомлений: NotificationService вместо Celery

**Решение:** Использовать встроенную систему уведомлений (`notifications.services.NotificationService`) вместо внедрения Celery.
...
4. ✅ **Масштаб проекта** - 50-200 сотрудников, <10 заявок/день - синхронная отправка приемлема
5. ✅ **Меньше точек отказа** - нет дополнительных worker'ов для мониторинга
