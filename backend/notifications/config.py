...
DEFAULT_CONFIG = {
    ...
    # URL иконки по умолчанию (None = browser default)
    "PUSH_DEFAULT_ICON": None,
    ...
    # None = использовать settings.DEFAULT_FROM_EMAIL
...
def get_config():
    ...
    Объединяет DEFAULT_CONFIG с пользовательскими настройками
    из settings.NOTIFICATIONS_CONFIG.
