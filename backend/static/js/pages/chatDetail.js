/**
 * @fileoverview Chat Detail Page - рефакторированная V2 архитектура
 * @module pages/chatDetail
 * 
 * V2 АРХИТЕКТУРА (чистый код):
 * - Прямой импорт ChatControllerV2 без промежуточных слоев
 * - MessageStoreV2 с бинарным поиском
 * - MessageLoaderV2 с retry-логикой и поддержкой around/latest
 * - ScrollManagerV2 с debounce/throttle
 * - Нет deprecated оберток (window.messageRenderer удалены)
 * - Поддержка lastReadTimestamp как fallback для скролла
 */
