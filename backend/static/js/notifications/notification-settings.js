    ...
    const categories = [
      {
        ...
        name: "Коммуникации",
        icon: "bi-chat-dots",
        description: "Сообщения, упоминания, ответы в чатах",
      },
      {
        code: "documents",
        name: "Документы",
        icon: "bi-file-earmark-text",
        description: "Новые документы, ознакомления",
      },
      {
        code: "requests",
        name: "Заявления",
        icon: "bi-clipboard-check",
        description: "Заявки, согласования, комментарии",
      },
      {
        code: "calendar",
        name: "Календарь",
        icon: "bi-calendar-event",
        description: "События, напоминания, изменения",
      },
      {
        code: "department",
        name: "Отдел",
        icon: "bi-people",
        description: "Изменения в структуре отдела",
      },
      {
        code: "profile",
        name: "Профиль",
        icon: "bi-person",
        description: "Изменения профиля и безопасности",
      },
      {
        code: "feed",
        name: "Новости",
      ...
      },
      {
        ...
        name: "Система",
        icon: "bi-gear",
        description: "Системные уведомления и обновления",
      },
    ];
                            ...
                            <div class="d-flex align-items-start mb-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="form-check form-switch mb-2">
                                        ...
                                        <label class="form-check-label" for="enable_${
                                          cat.code
                                        }">
                                    ...
                                    <div class="ps-4 ${
                                      setting.is_enabled ? "" : "d-none"
                                    }" id="channels_${cat.code}">
                                        <div class="form-check mb-2">
                                            ...
                                            <label class="form-check-label" for="web_${
                                              cat.code
                                            }">
                                            ...
                                            <select class="form-select form-select-sm email-frequency-select"
                                                ...
                                                <option value="daily" ${
                                                  ...
                                                  "daily"
                                                    ? "selected"
                                                    : ""
                                                }>Ежедневный дайджест</option>
                                                <option value="weekly" ${
                                                  setting.email_frequency ===
                                                  "weekly"
                                                    ? "selected"
                                                    : ""
                                                }>Еженедельный дайджест</option>
                                            </select>
                                        </div>
                                        `
                                            : ""
                                        ...
                                        <div class="form-check mb-2">
                                            ...
                                            <label class="form-check-label" for="telegram_${
                                              cat.code
                                            }">
  ...
  async updateSetting(category, field, value) {
    try {
      const response = await fetch(
        "/api/v1/notifications/settings/category/update/",
        {
          method: "PUT",
          credentials: "same-origin",
          headers: {
