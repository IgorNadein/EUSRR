...
class NotificationManager {
    ...
    renderNotifications(notifications) {
        ...
        listElement.innerHTML = notifications.map(n => this.renderNotificationItem(n)).join('');
    ...
    renderNotificationItem(notification) {
        ...
        return `
            <div class="notification-item ${!notification.is_read ? 'unread' : ''}"
                ...
                ${!notification.is_read ? '<div class="notification-unread-badge"></div>' : ''}
            </div>
        `;
    }
    ...
    showBrowserNotification(notification) {
        ...
        try {
            ...
            console.log('[Notifications] Browser notification shown:', notification.title);
        } catch (error) {
    ...
    showToast(notification) {
        ...
        const toastHtml = `
            <div class="toast align-items-center border-0 bg-${notification.color} text-white" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
