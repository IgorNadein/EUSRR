"""
ViewSets for Communications API
Рефакторинг с FBV на ViewSets для единообразия с остальным API
"""
import logging
        ...
        with transaction.atomic():
            ...
            for original_msg in messages:
                forwarded = Message.objects.create(
                    ...
                    forwarded_from_chat_name=original_msg.chat.name or 'Unknown',
