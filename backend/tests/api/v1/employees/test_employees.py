...
def test_retrieve_requires_auth(api_client: APIClient, ensure_ldap_disabled):
...
def test_retrieve_ok(api_client: APIClient, ensure_ldap_disabled):
    user = make_user("u@example.com")
    e = make_user("x@example.com")
    api_client.force_authenticate(user=user)
...
def test_search_by_email_and_last_name(api_client: APIClient, ensure_ldap_disabled):
...
def test_filter_by_department_includes_members_and_head(api_client: APIClient, ensure_ldap_disabled):
...
def test_filter_by_position(api_client: APIClient, ensure_ldap_disabled):
    u = make_user("u@example.com")
    api_client.force_authenticate(user=u)
...
def test_filter_by_skills_any_of(api_client: APIClient, ensure_ldap_disabled):
    u = make_user("u@example.com")
    api_client.force_authenticate(user=u)
...
def test_filter_by_email_verified_and_active(api_client: APIClient, ensure_ldap_disabled):
    u = make_user("u@example.com")
    api_client.force_authenticate(user=u)
...
def test_filter_actually_active_logic(api_client: APIClient, ensure_ldap_disabled):
    u = make_user("u@example.com")
    api_client.force_authenticate(user=u)
...
def test_partial_update_self_allowed(api_client: APIClient, ensure_ldap_disabled):
...
def test_partial_update_other_forbidden_for_regular_user(api_client: APIClient, ensure_ldap_disabled):
...
def test_partial_update_other_allowed_for_staff(api_client: APIClient, ensure_ldap_disabled):
...
def test_destroy_requires_admin(api_client: APIClient, ensure_ldap_disabled):
...
def test_me_get_returns_current_user(api_client: APIClient, ensure_ldap_disabled):
    me = make_user("me@example.com")
    api_client.force_authenticate(user=me)
...
def test_me_patch_updates_profile(api_client: APIClient, ensure_ldap_disabled):
...
def test_me_patch_rejects_when_all_contacts_empty(api_client: APIClient, ensure_ldap_disabled):
    """
